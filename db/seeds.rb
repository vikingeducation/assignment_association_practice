...
10.times do |i|
  ...
  2.times do
    j = rand(1..10)
    Post.create!(title: "#{j}: Lorem ipsum dolor sit amet.", body: "#{j} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia nisi nihil iste beatae esse dignissimos quam facere, consequuntur explicabo amet.", category_id: "#{j}")
  end
