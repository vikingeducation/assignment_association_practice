...
ActiveRecord::Schema.define(version: 20150929130751) do
  ...
  add_index "user_postings", ["post_id"], name: "index_user_postings_on_post_id"
  add_index "user_postings", ["user_id"], name: "index_user_postings_on_user_id"
