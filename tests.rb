...
puts "Lucky comment of the day is ##{random_post.id}. Old category: #{random_post.category.name}."
...
random_comment = Comment.all.sample
puts "Lucky comment of the day is ##{random_comment.id}. Its author is #{random_comment.user}."
